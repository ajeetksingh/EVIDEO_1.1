...
function deleteBookmark(id)
{
	...
	var xmlhttp;
		...
		xmlhttp.open("GET","http://172.18.1.15:81/json-delete-bookmark.php?"+str+'&jsoncallback=?',true);
		xmlhttp.send();
...
function deleteLink(id)
{
	...
	var xmlhttp;
		...
		xmlhttp.open("GET","http://172.18.1.15:81/json-delete-link.php?"+str+'&jsoncallback=?',true);
		xmlhttp.send();
		popup('popUpDiv5');
	}
}
	...
	if (r==true)
  	{
		...
		xmlhttp.open("GET","http://172.18.1.15:81/json-delete-annotation.php?"+str+'&jsoncallback=?',true);
		xmlhttp.send();
		popup('popUpDiv6');
	}
...
function editAnnotation(id)
{
		...
		var titleid;
		 var str= "id="+id+"&media_id="+mid;
 				 $.getJSON('http://172.18.1.15:81/json-retrieve-annotation.php?'+str+'&jsoncallback=?', function(r) {
...
function seekVideoPage(id)
{
		...
		var user=readCookie('sessionId');
		 var str= "id="+id+"&user="+user;
 				 $.getJSON('http://172.18.1.15:81/json-retrieve-bookmark-nextid.php?'+str+'&jsoncallback=?', function(r) {
 		console.log("Inside getJSON");
			//alert(r);
			r=JSON.stringify(r);
			var temp =JSON.parse(r); 
			...
			if(media_id)
			{
			window.location = "http://172.18.1.15:81/engage/ui/watch.html?id="+media_id+"&start="+start+"&stop="+stop+"&bid="+bid;
                      }
			else
			{
...
function seekVideo(id)
{
		...
		var media_id;
		 var str= "id="+id;
 				 $.getJSON('http://172.18.1.15:81/json-retrieve-bookmark.php?'+str+'&jsoncallback=?', function(r) {
 		console.log("Inside getJSON");
			//alert(r);
			r=JSON.stringify(r);
			var temp =JSON.parse(r); 
			...
			if(media_id)
			{
			window.location = "http://localhost/engage/ui/watch.html?id="+media_id+"&start="+start+"&stop="+stop+"&bid="+id;
                      }
			else
			{
				alert("End of Bookmarks");
...
function seekVideoForBookmark(id)
{
		...
		var media_id;
 		...
 		console.log("Inside getJSON");
			...
			if(media_id)
			{
			window.location = "http://172.18.1.15:81/engage/ui/watch.html?id="+media_id+"&start="+start+"&bid="+id+"&run="+runCommand;
                      }
...
function downloadPlaylist(pid)
{
		 ...
		 var str= "id="+pid;
 				 $.getJSON('http://172.18.1.15:81/json-retrieve-playlist.php?'+str+'&jsoncallback=?', function(r) {
		...
		xmlhttp.open("GET","http://172.18.1.15:81/play/index.php?pname="+play+"&uname="+user,true);
		xmlhttp.send();
		});
...
function deletePlaylist(id)
{
	...
	var xmlhttp;
		...
		xmlhttp.open("GET","http://172.18.1.15:81/json-delete-playlist.php?"+str+'&jsoncallback=?',true);
		xmlhttp.send();
		popup('popUpDiv9');
...
/*nction deleteAll()
{
	...
	var str= "user="+user;
					...
					xmlhttp.open("GET","http://172.18.1.15:81/play/deleteFolder.php?"+str+'&jsoncallback=?',true);
					xmlhttp.send();
}*/
 		...
 		console.log("Inside changePlaylist");
			...
			if(document.getElementById("plbtn"+pid).innerHTML == "Make Playlist"){
				...
				//$("playerFlow").load();
					...
					xmlhttp.open("GET","http://172.18.1.15:81/play/createPlaylistFolder.php?"+str+'&jsoncallback=?',true);
					xmlhttp.send();
			}
			else{
			...
			//var player= flowplayer("playerFlow", "flowplayer-3.2.7.swf", "http://172.18.1.15:81/play/ajeet_timesofindia/oa.mp4" );
			//$("playerFlow").load();
			...
			/*if(media_id)
			{
			window.location = "http://localhost/engage/ui/watch.html?id="+media_id+"&start="+start+"&stop="+stop+"&bid="+bid;
                      }
			else
			{
				alert("End of Bookmarks");
...
function editBookmark(id)
				{
					...
					//alert(str);	
				        $.getJSON('http://172.18.1.15:81/get-bookmark-data.php?'+str+'&jsoncallback=?', function(r) {
 					console.log("Inside getJSON");
                      			r=JSON.stringify(r);
                       			var temp =JSON.parse(r); 
                     			console.log(temp[0].title);
...
function editLink(id)
				{
					...
					//alert(str);	
				        $.getJSON('http://172.18.1.15:81/get-link-data.php?'+str+'&jsoncallback=?', function(r) {
 					console.log("Inside getJSON");
                      			r=JSON.stringify(r);
                       			var temp =JSON.parse(r); 
                     			console.log(temp[0].title);
		...
		xmlhttp.open("GET","http://172.18.1.15:81/update-link-data.php?"+str+'&jsoncallback=?',true);
		xmlhttp.send();
...
function updateBookmark()
		...
		xmlhttp.open("GET","http://172.18.1.15:81/update-bookmark-data.php?"+str+'&jsoncallback=?',true);
		xmlhttp.send();
		popup('popUpBookmarkEdit');		
...
(function ($) {
    ...
    // if (local) {
    //     $('head').append('<link rel="stylesheet" href="http://localhost/style/default.css" type="text/css" />');
    // } else {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    vp.load_app = function (str) {
		 ...
		 $.getJSON('http://172.18.1.15:81/json-create-Annotation.php?media_id='+videoid+'&jsoncallback=?', function(r) {
 		console.log("Inside getJSON");
...
vp1.load_app1 = function (str) {
     /*   var key = get_nptel_vid(), ks;
		...
		/*$.getJSON('vp_nptel-data.js', function (r) {
		 ...
		 $.getJSON('http://172.18.1.15:81/json-create.php?media_id='+videoid+'&jsoncallback=?', function(r) {
 		console.log("Inside getJSON");
                      console.log(JSON.stringify(r));
                      //create_sidebar(r,str);
			create_sidebar1(r,str);
...
vp2.load_app2 = function (str) {
     /*   var key = get_nptel_vid(), ks;
		...
		/*$.getJSON('vp_nptel-data.js', function (r) {
		 ...
		 $.getJSON('http://172.18.1.15:81/search_data.php?user='+user+'&title=algo&run=annotations&jsoncallback=?', function(r) {
 		console.log("Inside getJSON");
                      console.log(JSON.stringify(r));
                      //create_sidebar(r,str);
...
vp4.load_app4 = function (str) {
     /*   var key = get_nptel_vid(), ks;
		...
		/*$.getJSON('vp_nptel-data.js', function (r) {
		 ...
		 $.getJSON('http://172.18.1.15:81/json-get-playlist.php?user='+user+'&jsoncallback=?', function(r) {
 		console.log("Inside getJSON");
                      console.log(JSON.stringify(r));
                      //create_sidebar(r,str);
