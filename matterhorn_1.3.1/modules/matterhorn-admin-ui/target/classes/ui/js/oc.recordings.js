  ...
  this.makeActions = function(recording, actions) {
    ...
    $.each(actions, function(index, action) {
      if (action == 'view') {
        ...
        links.push('<a href="javascript:ocRecordings.publishRecording(\'' + id + '\')">Publish</a>');

      } else if (action == 'ignore') {
        links.push('<a title="Remove this Recording from UI only" href="javascript:ocRecordings.stopWorkflow(\'' + id + '\')">Ignore</a>');

      } else if (action == 'remove') {
        links.push('<a title="Remove this Recording from UI only" href="javascript:ocRecordings.stopWorkflow(\'' + id + '\')">Remove</a>');
