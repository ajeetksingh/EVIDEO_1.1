...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-version3 --enable-nonfree --disable-ffplay --disable-ffserver --extra-cflags='-I${LOCAL_PREFIX}/include' --extra-ldflags='-L${LOCAL_PREFIX}/lib -Wl,-rpath,${LOCAL_PREFIX}/lib' --enable-libxvid --extra-libs=-lxvidcore --enable-libx264 --extra-libs='-lx264 -lpthread' --enable-libmp3lame --extra-libs=-lmp3lame --enable-libfaac --extra-libs=-lfaac --enable-libvorbis --extra-libs=-lvorbis --enable-libtheora --extra-libs=-ltheora --enable-libvpx --extra-libs=-lvpx --enable-runtime-cpudetect
prefix=/usr/local
...
SRC_PATH="/opt/matterhorn/matterhorn_1.3.1/docs/scripts/3rd_party/ffmpeg/ffmpeg-0.8.2-linux"
SRC_PATH_BARE=/opt/matterhorn/matterhorn_1.3.1/docs/scripts/3rd_party/ffmpeg/ffmpeg-0.8.2-linux
...
CFLAGS= -I/usr/local/include  -std=c99 -fomit-frame-pointer -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/local/include/SDL -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -I/usr/local/include  -g
CC_O=-o $@
LDFLAGS= -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,libpostproc -Wl,-rpath-link,libswscale -Wl,-rpath-link,libavfilter -Wl,-rpath-link,libavdevice -Wl,-rpath-link,libavformat -Wl,-rpath-link,libavcodec -Wl,-rpath-link,libavutil
...
EXTRALIBS=-Wl,-rpath,/usr/local/lib -L/usr/local/lib -lSDL -lpthread -lxvidcore -lx264 -lvpx -lvpx -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lmp3lame -lfaac -lm -lbz2 -lz -lvpx -ltheora -lvorbis -lfaac -lmp3lame -lx264 -lpthread -lxvidcore 
INSTALL=install
LIBTARGET=
